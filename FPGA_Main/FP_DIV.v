...
//altfp_div CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone III" OPTIMIZE="SPEED" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab division_by_zero nan overflow result underflow zero
...
//altfp_div_pst CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" FILE_NAME="FP_DIV.v:a" PIPELINE=10 WIDTH_EXP=11 WIDTH_MAN=52 aclr clk_en clock dataa datab division_by_zero nan overflow result underflow zero
//VERSION_BEGIN 13.0 cbx_altbarrel_shift 2013:06:12:18:03:43:SJ cbx_altfp_div 2013:06:12:18:03:43:SJ cbx_altsyncram 2013:06:12:18:03:43:SJ cbx_cycloneii 2013:06:12:18:03:43:SJ cbx_lpm_abs 2013:06:12:18:03:43:SJ cbx_lpm_add_sub 2013:06:12:18:03:43:SJ cbx_lpm_compare 2013:06:12:18:03:43:SJ cbx_lpm_decode 2013:06:12:18:03:43:SJ cbx_lpm_divide 2013:06:12:18:03:43:SJ cbx_lpm_mult 2013:06:12:18:03:43:SJ cbx_lpm_mux 2013:06:12:18:03:43:SJ cbx_mgl 2013:06:12:18:05:10:SJ cbx_padd 2013:06:12:18:03:43:SJ cbx_stratix 2013:06:12:18:03:43:SJ cbx_stratixii 2013:06:12:18:03:43:SJ cbx_stratixiii 2013:06:12:18:03:43:SJ cbx_stratixv 2013:06:12:18:03:43:SJ cbx_util_mgl 2013:06:12:18:03:43:SJ  VERSION_END

//synthesis_resources = altsyncram 1 lpm_add_sub 8 lpm_compare 1 lpm_mult 9 mux21 141 reg 1330 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_DIV_altfp_div_pst_85j
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	defparam
		...
		altsyncram3.intended_device_family = "Cyclone III",
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   zero_pipe_dffe_0 <= (~ exp_a_not_zero_w[10]);
	// synopsys translate_off
	initial
		zero_pipe_dffe_1 = 0;
	// synopsys translate_on
	...
	assign
		...
		zero = zero_dffe_wo,
		zero_dffe_wi = (((zero_pipe_dffe_8 | underflow_dffe_6) | (b_is_infinity_dffe_8 & (~ a_is_infinity_dffe_8))) & (~ nan_pipe_dffe_8)),
		zero_dffe_wo = zero_dffe;
endmodule //FP_DIV_altfp_div_pst_85j

//synthesis_resources = altsyncram 1 lpm_add_sub 8 lpm_compare 1 lpm_mult 9 mux21 141 reg 1330 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_DIV_altfp_div_tql
	( 
	clock,
	dataa,
	datab,
	...
	FP_DIV_altfp_div_pst_85j   altfp_div_pst1
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		underflow = wire_altfp_div_pst1_underflow,
		zero = wire_altfp_div_pst1_zero;
endmodule //FP_DIV_altfp_div_tql
//VALID FILE
...
module FP_DIV (
	...
	FP_DIV_altfp_div_tql	FP_DIV_altfp_div_tql_component (
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
				.overflow (sub_wire0),
