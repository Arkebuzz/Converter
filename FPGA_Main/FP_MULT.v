...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone III" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab nan overflow result underflow zero
...
//synthesis_resources = lpm_add_sub 4 lpm_mult 1 reg 501 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_MULT_altfp_mult_kjq
	( 
	clock,
	dataa,
	datab,
	...
	assign
		...
		zero = zero_ff;
endmodule //FP_MULT_altfp_mult_kjq
//VALID FILE
...
module FP_MULT (
	...
	FP_MULT_altfp_mult_kjq	FP_MULT_altfp_mult_kjq_component (
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
				.overflow (sub_wire0),
