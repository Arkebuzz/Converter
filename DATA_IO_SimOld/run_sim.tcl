...
if {[catch {restart -f}] == 0} {
    ...
    add wave -noupdate -divider "PCON REGISTERS OUT"
    add wave -noupdate -unsigned /tb_system_top/u_pcon_io/TX_SM_STATE
    add wave -noupdate -unsigned /tb_system_top/u_pcon_io/TX_DATA_COUNTER
    add wave -noupdate -unsigned /tb_system_top/u_pcon_io/TX_BIT_COUNTER
    
    add wave -noupdate -divider "PCON REGISTERS INP"
    add wave -noupdate           /tb_system_top/u_pcon_io/RX_DATA_READ_VALUE
    add wave -noupdate -unsigned /tb_system_top/u_pcon_io/RX_BIT_COUNTER
