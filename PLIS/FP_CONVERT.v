...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 clock dataa result
...
module  FP_CONVERT_altbarrel_shift_kuf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FP_CONVERT_altbarrel_shift_kuf
...
module  FP_CONVERT_altpriority_encoder_6v7
	...
	FP_CONVERT_altpriority_encoder_3v7   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q));
	FP_CONVERT_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
module  FP_CONVERT_altpriority_encoder_6e8
	...
	FP_CONVERT_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[1:0]),
...
module  FP_CONVERT_altpriority_encoder_bv7
	...
	FP_CONVERT_altpriority_encoder_6v7   altpriority_encoder10
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder10_q));
	FP_CONVERT_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[7:4]),
...
module  FP_CONVERT_altpriority_encoder_be8
	...
	FP_CONVERT_altpriority_encoder_6e8   altpriority_encoder17
	( 
	.data(data[7:4]),
...
module  FP_CONVERT_altpriority_encoder_r08
	...
	FP_CONVERT_altpriority_encoder_bv7   altpriority_encoder8
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder8_q));
	FP_CONVERT_altpriority_encoder_be8   altpriority_encoder9
	( 
	.data(data[15:8]),
...
module  FP_CONVERT_altpriority_encoder_rf8
	...
	FP_CONVERT_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[15:8]),
...
module  FP_CONVERT_altpriority_encoder_qb6
	...
	FP_CONVERT_altpriority_encoder_r08   altpriority_encoder6
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder6_q));
	FP_CONVERT_altpriority_encoder_rf8   altpriority_encoder7
	( 
	.data(data[31:16]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_CONVERT_altfp_convert_t1n
	( 
	clock,
	dataa,
	result) ;
	...
	FP_CONVERT_altbarrel_shift_kuf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //FP_CONVERT_altfp_convert_t1n
//VALID FILE
...
module FP_CONVERT (
	...
	FP_CONVERT_altfp_convert_t1n	FP_CONVERT_altfp_convert_t1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL FP_CONVERT.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FP_CONVERT.cmp FALSE TRUE
