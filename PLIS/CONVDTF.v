...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" OPERATION="FLOAT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa nan overflow result underflow
...
//synthesis_resources = lpm_add_sub 3 lpm_compare 1 reg 140 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  CONVDTF_altfp_convert_ffp
	( 
	clock,
	dataa,
	nan,
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) nan_reg2 <= 1'b0;
		else if  (clk_en == 1'b1)   nan_reg2 <= nan_selector_w;
	// synopsys translate_off
	initial
		overflow_reg = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   underflow_reg <= underflow_w;
	...
	assign
		...
		overflow = (overflow_reg & (~ nan_reg2)),
		...
		underflow_w = ((exp_com_nor_w | exponent_dp_sign_reg) & (~ (denormal_input_w | zero_input_w))),
...
endmodule //CONVDTF_altfp_convert_ffp
//VALID FILE
...
module CONVDTF (
	...
	CONVDTF_altfp_convert_ffp	CONVDTF_altfp_convert_ffp_component (
				.clock (clock),
				.dataa (dataa),
				.overflow (sub_wire0),
				.underflow (sub_wire1),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVDTF.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVDTF.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVDTF.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVDTF_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVDTF_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVDTF.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVDTF.cmp FALSE TRUE
