//###########################################################################
// FILE:   F28M35x_Ecap.h
// TITLE:  F28M35x Device eCAP Register Definitions.
//###########################################################################
// $TI Release: F28M35x Support Library v202 $
// $Release Date: Tue Apr  8 12:35:30 CDT 2014 $
//###########################################################################

#ifndef F28M35x_eCAP_H
#define F28M35x_eCAP_H
...
struct ECCTL1_BITS {                 // bits  description
        ...
        Uint16 CAPLDEN : 1;          // 8     Enable Loading CAP1-4 regs on a 
	                             //       Cap Event
...
struct ECCTL2_BITS {                 // bits description
        ...
        Uint16 STOP_WRAP : 2;        // 2:1   "Stop value for one-shot, Wrap
                                     //       for continuous"
...
struct ECEINT_BITS {                // bits description
        ...
        Uint16 CTR_EQ_PRD1 : 1;     // 6    Period Equal Interrupt Enable
...
struct ECFLG_BITS {             // bits description
        ...
        Uint16 CTR_EQ_PRD1 : 1; // 6    Period Equal Interrupt Flag
...
#endif  // end of F28M35x_eCAP_H definition
