//###########################################################################
// FILE:   F28M35x_Mcbsp.h
// TITLE:  F28M35x Device McBSP Register Definitions.
//###########################################################################
// $TI Release: F28M35x Support Library v202 $
// $Release Date: Tue Apr  8 12:35:30 CDT 2014 $
//###########################################################################

#ifndef F28M35x_McBSP_H
#define F28M35x_McBSP_H
...
struct SPCR1_BITS {              // bits description
        ...
        Uint16 rsvd1 : 3;        // 10:8  Reserved
        Uint16 CLKSTP : 2;       // 12:11 Clock stop mode
        Uint16 RJUST : 2;        // 14:13 Rx sign extension and justification
                                 //       mode
...
struct PCR_BITS {                    // bits description
        ...
        Uint16 FSRP : 1;             // 2     Receive Frame synchronization
                                     //       polarity
        Uint16 FSXP : 1;             // 3     Transmit Frame synchronization
                                     //       polarity
        ...
        Uint16 FSXM : 1;             // 11    Transmit Frame Synchronization
                                     //       Mode
...
#endif  // end of F28M35x_McBSP_H definition
