//###########################################################################
// FILE:    F28M35x_SWPrioritizedIsrLevels.h
...
#ifndef F28M35x_SW_PRIORITZIED_ISR_H
#define F28M35x_SW_PRIORITZIED_ISR_H
...
#define    G11PL       7        // ADCINT1     (ADC)  or reserved if 10.1 is
#define    G12PL       6        // ADCINT2     (ADC)  or reserved if 10.2 is
...
#define    G28PL       1        // EPWM8_TZINT (ePWM8 Trip)
...
#define    G38PL       3        // EPWM8_INT   (ePWM8 Int)

#define    G41PL       1        // ECAP1_INT   (eCAP1 Int)
#define    G42PL       3        // ECAP2_INT   (eCAP2 Int)
#define    G43PL       2        // ECAP3_INT   (eCAP3 Int)
#define    G44PL       4        // ECAP4_INT   (eCAP4 Int)
#define    G45PL       1        // ECAP5_INT   (eCAP5 Int)
#define    G46PL       3        // ECAP6_INT   (eCAP6 Int)
#define    G47PL       0        // reserved
#define    G48PL       0        // EPWM9_TZINT (ePWM9 Trip)

#define    G51PL       1        // EQEP1_INT   (eQEP1 Int)
#define    G52PL       3        // EQEP2_INT   (eQEP2 Int)
#define    G53PL       2        // EQEP3_INT   (eQEP3 Int)
#define    G54PL       0        // reserved
#define    G55PL       0        // reserved
#define    G56PL       0        // reserved
#define    G57PL       0        // reserved
#define    G58PL       3        // EPWM9_INT    (ePWM9)
...
#define    G66PL       3        // MXINTA      (McBSP-A)
#define    G67PL       0        // reserved
#define    G68PL       0        // reserved

#define    G71PL      1        // DMA Channel 1
#define    G72PL      2        // DMA Channel 2
#define    G73PL      3        // DMA Channel 3
#define    G74PL      2        // DMA Channel 4
#define    G75PL      6        // DMA Channel 5
#define    G76PL      4        // DMA Channel 6
...
#define    G101PL      0        // reserved  or ADCINT1 (define G11PL as 0 /
                                // reserved)
#define    G102PL      0        // reserved  or ADCINT2 (define G12PL as 0 /
                                // reserved)
...
#define    G111PL      1        // MTOCIPCINT1 (MTOCIPC)
#define    G112PL      2        // MTOCIPCINT2 (MTOCIPC)
#define    G113PL      4        // MTOCIPCINT3 (MTOCIPC)
#define    G114PL      3        // MTOCIPCINT4 (MTOCIPC)
...
#define    G122PL      3        // CFLSINGERR (Flash Single Error)
#define    G123PL      7        // CFLFSM
#define    G124PL      2        // CRAMSINGERR (RAM Single Error)
#define    G125PL      2        // CRAMACCVIOL (RAM Access Violation)
#define    G126PL      0        // reserved
#define    G127PL      3        // LVF    (Latched Overflow)
#define    G128PL      2        // LUF (Latched Underflow)
