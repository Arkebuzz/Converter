//###########################################################################
// FILE:   F28M35x_Dma.h
// TITLE:  F28M35x Device DMA Register Definitions.
//###########################################################################
// $TI Release: F28M35x Support Library v202 $
// $Release Date: Tue Apr  8 12:35:30 CDT 2014 $
//###########################################################################

#ifndef F28M35x_DMA_H
#define F28M35x_DMA_H
...
struct MODE_BITS {                       // bits description
        Uint16 PERINTSEL : 5;            // 4:0  Peripheral Interrupt and Sync
                                         //      Select
...
struct PRIORITYSTAT_BITS {               // bits description
        ...
        Uint16 ACTIVESTS_SHADOW : 3;     // 6:4  Active Channel Status Shadow
                                         //      Bits
...
struct CH_REGS {
        ...
        union    BURST_COUNT_REG BURST_COUNT;             // Burst Count
                                                          // Register
        int16 SRC_BURST_STEP;                             // Source Burst Step
                                                          // Register
        int16 DST_BURST_STEP;                             // Destination Burst
                                                          // Step Register
        Uint16 TRANSFER_SIZE;                             // Transfer Size
                                                          // Register
        Uint16 TRANSFER_COUNT;                            // Transfer Count
                                                          // Register
        int16 SRC_TRANSFER_STEP;                          // Source Transfer
                                                          // Step Register
        int16 DST_TRANSFER_STEP;                          // Destination
                                                          // Transfer Step
                                                          // Register
        Uint16 SRC_WRAP_SIZE;                             // Source Wrap Size
                                                          // Register
        Uint16 SRC_WRAP_COUNT;                            // Source Wrap Count
                                                          // Register
        int16 SRC_WRAP_STEP;                              // Source Wrap Step
                                                          // Register
        Uint16 DST_WRAP_SIZE;                             // Destination Wrap
                                                          // Size Register
        Uint16 DST_WRAP_COUNT;                            // Destination Wrap
                                                          // Count Register
        int16 DST_WRAP_STEP;                              // Destination Wrap
                                                          // Step Register
        Uint32 SRC_BEG_ADDR_SHADOW;                       // Source Begin
                                                          // Address Shadow
                                                          // Register
        Uint32 SRC_ADDR_SHADOW;                           // Source Address
                                                          // Shadow Register
        Uint32 SRC_BEG_ADDR_ACTIVE;                       // Source Begin
                                                          // Address Active
                                                          // Register
        Uint32 SRC_ADDR_ACTIVE;                           // Source Address
                                                          // Active Register
        Uint32 DST_BEG_ADDR_SHADOW;                       // Destination Begin
                                                          // Address Shadow
                                                          // Register
        Uint32 DST_ADDR_SHADOW;                           // Destination Address
                                                          // Shadow Register
        Uint32 DST_BEG_ADDR_ACTIVE;                       // Destination Begin
                                                          // Address Active
                                                          // Register
        Uint32 DST_ADDR_ACTIVE;                           // Destination Address
                                                          // Active Register
};
...
struct DMA_REGS {
        ...
        union    PRIORITYCTRL1_REG PRIORITYCTRL1;   // Priority Control 1
                                                    // Register
        Uint16 rsvd3;                               // Reserved
        union    PRIORITYSTAT_REG PRIORITYSTAT;     // Priority Status Register
        Uint16 rsvd4[25];                           // Reserved
...
#endif  // end of F28M35x_DMA_H definition
