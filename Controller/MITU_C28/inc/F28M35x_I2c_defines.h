//###########################################################################
// FILE:    F28M35x_I2c_defines.h
// TITLE:   F28M35x I2C Example Code Definitions.
//###########################################################################
// $TI Release: F28M35x Support Library v202 $
// $Release Date: Tue Apr  8 12:35:30 CDT 2014 $
//###########################################################################

#ifndef F28M35x_I2C_DEFINES_H
#define F28M35x_I2C_DEFINES_H
...
struct I2CMSG {
    Uint16 MsgStatus;           // Word stating what state msg is in:
                                ...
                                //       master trans msg complete with a stop
                                //       bit
    ...
    Uint16 NumOfBytes;          // Num of valid bytes in (or to be put in
                                //       MsgBuffer)
    Uint16 MemoryHighAddr;      // EEPROM address of data associated with msg
                                //       (high byte)
    Uint16 MemoryLowAddr;       // EEPROM address of data associated with msg
                                //       (low byte)
...
#endif  // end of F28M35x_I2C_DEFINES_H definition
