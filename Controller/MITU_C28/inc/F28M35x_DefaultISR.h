//###########################################################################
// FILE:    F28M35x_DefaultIsr.h
// TITLE:   F28M35x Devices Default Interrupt Service Routines Definitions.
//###########################################################################
// $TI Release: F28M35x Support Library v202 $
// $Release Date: Tue Apr  8 12:35:30 CDT 2014 $
//###########################################################################

#ifndef F28M35x_DEFAULT_ISR_H
#define F28M35x_DEFAULT_ISR_H
...
// This default vector table is found in the 28M35x_PieVect.h
// file.
...
__interrupt void EPWM9_TZINT_ISR(void);     // EPWM Trip Zone-9
...
__interrupt void MTOCIPC_INT1_ISR(void);      // MTOCIPC INT1 ISR
__interrupt void MTOCIPC_INT2_ISR(void);      // MTOCIPC INT2 ISR
__interrupt void MTOCIPC_INT3_ISR(void);      // MTOCIPC INT3 ISR
__interrupt void MTOCIPC_INT4_ISR(void);      // MTOCIPC INT4 ISR
...
__interrupt void CFLFSM_ISR(void);
...
#endif    // end of F28M35x_DEFAULT_ISR_H definition
