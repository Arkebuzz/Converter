//###########################################################################
// FILE:   F28M35x_Adc.h
// TITLE:  F28M35x Device ADC Register Definitions.
//###########################################################################
...
#ifndef F28M35x_ADC_H
#define F28M35x_ADC_H
...
struct ADCCTL1_BITS {                // bits description
        ...
        Uint16 VREFLOCONV : 1;       // 1    Vreflo access enable on B5
        Uint16 INTPULSEPOS : 1;      // 2    Late ADCINT enable
        Uint16 ADCREFSEL : 1;        // 3    Internal/external reference select
        Uint16 rsvd2 : 1;            // 4    Reserved
        Uint16 ADCREFPWD : 1;        // 5    Reference buffers circuit power
                                     //      down
        Uint16 ADCBGPWD : 1;         // 6    Bandgap circuit power down
        Uint16 ADCPWDN : 1;          // 7    ADC power down.
        Uint16 ADCBSYCHN : 5;        // 12:8 Channel converted
...
struct ADCSAMPLEMODE_BITS {          // bits description
        Uint16 SIMULEN0 : 1;         // 0    Simultaneous sampling enable for
                                     //      SOC0
        Uint16 SIMULEN2 : 1;         // 1    Simultaneous sampling enable for
                                     //      SOC2
        Uint16 SIMULEN4 : 1;         // 2    Simultaneous sampling enable for
                                     //      SOC4
        Uint16 SIMULEN6 : 1;         // 3    Simultaneous sampling enable for
                                     //      SOC6
        Uint16 SIMULEN8 : 1;         // 4    Simultaneous sampling enable for
                                     //      SOC8
        Uint16 SIMULEN10 : 1;        // 5    Simultaneous sampling enable for
                                     //      SOC10
        Uint16 SIMULEN12 : 1;        // 6    Simultaneous sampling enable for
                                     //      SOC12
        Uint16 SIMULEN14 : 1;        // 7    Simultaneous sampling enable for
                                     //      SOC14
...
struct ADCINTSOCSEL2_BITS {          // bits description
        ...
        Uint16 SOC13 : 2;            // 11:10  ADCINT Start-of-conversion
                                     //        Select
        Uint16 SOC14 : 2;            // 13:12  ADCINT Start-of-conversion
                                     //        Select
        Uint16 SOC15 : 2;            // 15:14  ADCINT Start-of-conversion
                                     //        Select
};
...
struct ADCREFTRIM_BITS {                     // bits description
        Uint16 BG_FINE_TRIM : 5;             // 4:0    Course Trim for Internal
                                             //        BG
        Uint16 BG_COARSE_TRIM : 4;           // 8:5    Fine Trim for Internal BG
        Uint16 EXTREF_FINE_TRIM : 5;         // 13:9   Fine Trim for External
                                             //        Reference
...
struct COMPHYSTCTL_BITS {                // bits description
        Uint16 rsvd1 : 1;                // 0    reserved
        Uint16 COMP1_HYST_DISABLE : 1;   // 1    Comparator 1 or 4 Hysteresis
                                         //      Disable
        Uint16 rsvd2 : 4;                // 5:2  reserved
        Uint16 COMP2_HYST_DISABLE : 1;   // 6    Comparator 2 or 5 Hysteresis
                                         //      Disable
        Uint16 rsvd3 : 4;                // 10:7 reserved
        Uint16 COMP3_HYST_DISABLE : 1;   // 11   Comparator 3 or 6 Hysteresis
                                         //      Disable
...
struct ADC_REGS {
        ...
        union    ADCINT_REG ADCINTFLGCLR;             // Interrupt Flag Clear
                                                      // Register
        union    ADCINT_REG ADCINTOVF;                // Interrupt Overflow
                                                      // Register
        union    ADCINT_REG ADCINTOVFCLR;             // Interrupt Overflow
                                                      // Clear Register
        union    INTSEL1N2_REG INTSEL1N2;             // Interrupt 1 and 2
                                                      // Selection Register
        union    INTSEL3N4_REG INTSEL3N4;             // Interrupt 3 and 4
                                                      // Selection Register
        union    INTSEL5N6_REG INTSEL5N6;             // Interrupt 5 and 6
                                                      // Selection Register
        union    INTSEL7N8_REG INTSEL7N8;             // Interrupt 7 and 8
                                                      // Selection Register
        Uint16 rsvd3;                                 // Reserved
        Uint16 rsvd4;                                 // Reserved
        Uint16 rsvd5;                                 // Reserved
        Uint16 rsvd6;                                 // Reserved
        union    SOCPRICTL_REG SOCPRICTL;             // SOC Priority Control
                                                      // Register
        Uint16 rsvd7;                                 // Reserved
        union    ADCSAMPLEMODE_REG ADCSAMPLEMODE;     // Sampling Mode Register
        Uint16 rsvd8;                                 // Reserved
        union    ADCINTSOCSEL1_REG ADCINTSOCSEL1;     // Interrupt SOC Selection
                                                      // 1 Register (for 8
                                                      // channels)
        union    ADCINTSOCSEL2_REG ADCINTSOCSEL2;     // Interrupt SOC Selection
                                                      // 2 Register (for 8
                                                      // channels)
        Uint16 rsvd9;                                 // Reserved
        Uint16 rsvd10;                                 // Reserved
        union    ADCSOC_REG ADCSOCFLG1;               // SOC Flag 1 Register
                                                      // (for 16 channels)
        Uint16 rsvd11;                                // Reserved
        union    ADCSOC_REG ADCSOCFRC1;               // SOC Force 1 Register
                                                      // (for 16 channels)
        Uint16 rsvd12;                                // Reserved
        union    ADCSOC_REG ADCSOCOVF1;               // SOC Overflow 1 Register
                                                      // (for 16 channels)
        Uint16 rsvd13;                                // Reserved
        union    ADCSOC_REG ADCSOCOVFCLR1;            // SOC Overflow Clear 1
                                                      // Register (for 16
                                                      // channels)
        ...
        Uint16 rsvd16 [10];                           // reserved
        union   COMPHYSTCTL_REG COMPHYSTCTL;          // COMP Hysteresis Control
                                                      // Register
        Uint16 rsvd17 [3];                            // reserved
};
...
extern volatile struct ADC_RESULT_REGS Adc1Result;
extern volatile struct ADC_REGS Adc2Regs;
extern volatile struct ADC_RESULT_REGS Adc2Result;
...
#endif  // end of F28M35x_ADC_H definition
