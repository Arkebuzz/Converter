...
override PKGDIR = xconfig_tcpEcho
...
C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/ITarget.xs:
package.mak: C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/ITarget.xs
C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/C28_large.xs:
package.mak: C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/C28_large.xs
C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/C28_float.xs:
package.mak: C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/C28_float.xs
C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/package.xs:
package.mak: C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/package.xs
C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/IArm.xs:
package.mak: C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/IArm.xs
C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/package.xs:
package.mak: C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/package.xs
...
ti.targets.arm.elf.M3.rootDir ?= C:/ti/ccsv6/tools/compiler/ti-cgt-arm_16.9.0.LTS
ti.targets.arm.elf.packageBase ?= C:/ti/tirtos_c2000_2_16_00_08/products/bios_6_45_01_29/packages/ti/targets/arm/elf/
...
package/%.xdc.inc package/%_xconfig_tcpEcho.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_tcpEcho" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: tcpEcho.pem3

-include package/cfg/tcpEcho_pem3.mak
-include package/cfg/tcpEcho_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/tcpEcho_pem3.dep
endif
tcpEcho.pem3: package/cfg/tcpEcho_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
tcpEcho.pem3 package/cfg/tcpEcho_pem3.c: .libraries,em3
endif

package/cfg/tcpEcho_pem3.c package/cfg/tcpEcho_pem3.h package/cfg/tcpEcho_pem3.xdl: override _PROG_NAME := tcpEcho.xem3
package/cfg/tcpEcho_pem3.c: package/cfg/tcpEcho_pem3.cfg
package/cfg/tcpEcho_pem3.xdc.inc: package/cfg/tcpEcho_pem3.xdl
package/cfg/tcpEcho_pem3.xdl package/cfg/tcpEcho_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/tcpEcho_pem3.cfg
	-$(RM) package/cfg/tcpEcho_pem3.dep
	-$(RM) package/cfg/tcpEcho_pem3.c
	-$(RM) package/cfg/tcpEcho_pem3.xdc.inc

clean,em3::
	-$(RM) tcpEcho.pem3
.executables,em3 .executables: tcpEcho.xem3

tcpEcho.xem3: |tcpEcho.pem3

-include package/cfg/tcpEcho.xem3.mak
tcpEcho.xem3: package/cfg/tcpEcho_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/tcpEcho_pem3.oem3   package/cfg/tcpEcho_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
tcpEcho.xem3: export C_DIR=
tcpEcho.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
tcpEcho.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

tcpEcho.test test,em3 test: tcpEcho.xem3.test

tcpEcho.xem3.test:: tcpEcho.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 tcpEcho.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.tcpEcho.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,tcpEcho.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
tcpEcho_pem3.oem3,copy : package/cfg/tcpEcho_pem3.oem3
tcpEcho_pem3.sem3,copy : package/cfg/tcpEcho_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_tcpEcho
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_tcpEcho.tar.dep
endif
package/rel/xconfig_tcpEcho/xconfig_tcpEcho/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_tcpEcho/xconfig_tcpEcho/package/package.rel.xml: package/build.cfg
package/rel/xconfig_tcpEcho/xconfig_tcpEcho/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_tcpEcho/xconfig_tcpEcho/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_tcpEcho.tar: package/rel/xconfig_tcpEcho.xdc.inc package/rel/xconfig_tcpEcho/xconfig_tcpEcho/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_tcpEcho.xdc.inc,package/rel/xconfig_tcpEcho.tar.dep)


release release,xconfig_tcpEcho: all xconfig_tcpEcho.tar
clean:: .clean
	-$(RM) xconfig_tcpEcho.tar
	-$(RM) package/rel/xconfig_tcpEcho.xdc.inc
	-$(RM) package/rel/xconfig_tcpEcho.tar.dep
