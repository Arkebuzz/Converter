...
always @(posedge CLOCK_50) begin
   ...
   // ADCHub1 приём
   if (rc_ready_1 && ~rc_invalid_data_1 && ~rc_connect_fail_1) begin
   ...
   // ADCHub2 приём
   if (rc_ready_2 && ~rc_invalid_data_2 && ~rc_connect_fail_2) begin
