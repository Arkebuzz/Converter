...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone III" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 add_sub clock dataa datab nan overflow result underflow zero
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" PIPELINE=1 SHIFTDIR="LEFT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
...
module  FP_ADDSUB_altbarrel_shift_t3e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FP_ADDSUB_altbarrel_shift_t3e


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" SHIFTDIR="RIGHT" WIDTH=55 WIDTHDIST=6 data distance result
//VERSION_BEGIN 13.0 cbx_altbarrel_shift 2013:06:12:18:03:43:SJ cbx_mgl 2013:06:12:18:05:10:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altbarrel_shift_ikb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[5:0]},
		smux_w = {((({55{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[297:275], pad_w[31:0]}) | ({55{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[329:307]})) | ({55{(~ sel_w[5])}} & sbit_w[329:275])), ((({55{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[258:220], pad_w[15:0]}) | ({55{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[274:236]})) | ({55{(~ sel_w[4])}} & sbit_w[274:220])), ((({55{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[211:165], pad_w[7:0]}) | ({55{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[219:173]})) | ({55{(~ sel_w[3])}} & sbit_w[219:165])), ((({55{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[160:110], pad_w[3:0]}) | ({55{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[164:114]})) | ({55{(~ sel_w[2])}} & sbit_w[164:110])), ((({55{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[107:55], pad_w[1:0]}) | ({55{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[109:57]})) | ({55{(~ sel_w[1])}} & sbit_w[109:55])), ((({55{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[53:0], pad_w[0]}) | ({55{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[54:1]})) | ({55{(~ sel_w[0])}} & sbit_w[54:0]))};
endmodule //FP_ADDSUB_altbarrel_shift_ikb


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" PIPELINE=1 WIDTH=64 WIDTHAD=6 aclr clk_en clock data q
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //FP_ADDSUB_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	FP_ADDSUB_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	FP_ADDSUB_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //FP_ADDSUB_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	FP_ADDSUB_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	FP_ADDSUB_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //FP_ADDSUB_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	FP_ADDSUB_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	FP_ADDSUB_altpriority_encoder_be8   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //FP_ADDSUB_altpriority_encoder_rf8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //FP_ADDSUB_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_3v7   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	FP_ADDSUB_altpriority_encoder_3e8   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //FP_ADDSUB_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_6v7   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	FP_ADDSUB_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //FP_ADDSUB_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_bv7   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	FP_ADDSUB_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //FP_ADDSUB_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_rf8   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	FP_ADDSUB_altpriority_encoder_r08   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //FP_ADDSUB_altpriority_encoder_tv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_te9
	( 
	data,
	q,
	zero) ;
	...
	FP_ADDSUB_altpriority_encoder_rf8   altpriority_encoder23
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	FP_ADDSUB_altpriority_encoder_rf8   altpriority_encoder24
	( 
	.data(data[31:16]),
...
endmodule //FP_ADDSUB_altpriority_encoder_te9

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_uu8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	FP_ADDSUB_altpriority_encoder_tv8   altpriority_encoder7
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder7_q));
	FP_ADDSUB_altpriority_encoder_te9   altpriority_encoder8
	( 
	.data(data[63:32]),
...
endmodule //FP_ADDSUB_altpriority_encoder_uu8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //FP_ADDSUB_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	FP_ADDSUB_altpriority_encoder_nh8   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	FP_ADDSUB_altpriority_encoder_nh8   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //FP_ADDSUB_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	FP_ADDSUB_altpriority_encoder_qh8   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	FP_ADDSUB_altpriority_encoder_qh8   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //FP_ADDSUB_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_fj8
	( 
	data,
	q,
	zero) ;
	...
	FP_ADDSUB_altpriority_encoder_vh8   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	FP_ADDSUB_altpriority_encoder_vh8   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //FP_ADDSUB_altpriority_encoder_fj8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_ej8
	( 
	data,
	q,
	zero) ;
	...
	FP_ADDSUB_altpriority_encoder_fj8   altpriority_encoder27
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	FP_ADDSUB_altpriority_encoder_fj8   altpriority_encoder28
	( 
	.data(data[31:16]),
...
endmodule //FP_ADDSUB_altpriority_encoder_ej8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //FP_ADDSUB_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_nh8   altpriority_encoder41
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder41_q),
	.zero(wire_altpriority_encoder41_zero));
	FP_ADDSUB_altpriority_encoder_n28   altpriority_encoder42
	( 
	.data(data[3:2]),
...
endmodule //FP_ADDSUB_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_qh8   altpriority_encoder39
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder39_q),
	.zero(wire_altpriority_encoder39_zero));
	FP_ADDSUB_altpriority_encoder_q28   altpriority_encoder40
	( 
	.data(data[7:4]),
...
endmodule //FP_ADDSUB_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_vh8   altpriority_encoder37
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder37_q),
	.zero(wire_altpriority_encoder37_zero));
	FP_ADDSUB_altpriority_encoder_v28   altpriority_encoder38
	( 
	.data(data[15:8]),
...
endmodule //FP_ADDSUB_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_e48
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_fj8   altpriority_encoder35
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder35_q),
	.zero(wire_altpriority_encoder35_zero));
	FP_ADDSUB_altpriority_encoder_f48   altpriority_encoder36
	( 
	.data(data[31:16]),
...
endmodule //FP_ADDSUB_altpriority_encoder_e48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altpriority_encoder_k48
	( 
	data,
	q) ;
	input   [63:0]  data;
	...
	FP_ADDSUB_altpriority_encoder_ej8   altpriority_encoder25
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	FP_ADDSUB_altpriority_encoder_e48   altpriority_encoder26
	( 
	.data(data[63:32]),
...
endmodule //FP_ADDSUB_altpriority_encoder_k48

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 925 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_ADDSUB_altfp_add_sub_85n
	( 
	add_sub,
	clock,
	dataa,
...
`endif
	...
	reg	underflow_flag_dffe5;
	reg	zero_flag_n_dffe5;
	...
	wire  nan_flag_dffe5_wi;
	wire  nan_flag_dffe5_wo;
	wire  nan_flag_w;
	...
	wire  underflow_flag_dffe5_wi;
	wire  underflow_flag_dffe5_wo;
	wire  underflow_flag_w;
	wire  zero_flag_n_dffe5_wi;
	wire  zero_flag_n_dffe5_wo;
	wire  zero_flag_n_w;
	...
	FP_ADDSUB_altbarrel_shift_t3e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FP_ADDSUB_altbarrel_shift_ikb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	FP_ADDSUB_altpriority_encoder_uu8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FP_ADDSUB_altpriority_encoder_k48   trailing_zeros_cnt
	( 
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) nan_flag_dffe5 <= 1'b0;
		else if  (clk_en == 1'b1)   nan_flag_dffe5 <= nan_flag_dffe5_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_off
	initial
		underflow_flag_dffe5 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) underflow_flag_dffe5 <= 1'b0;
		else if  (clk_en == 1'b1)   underflow_flag_dffe5 <= underflow_flag_dffe5_wi;
	// synopsys translate_off
	initial
		zero_flag_n_dffe5 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) zero_flag_n_dffe5 <= 1'b0;
		else if  (clk_en == 1'b1)   zero_flag_n_dffe5 <= zero_flag_n_dffe5_wi;
	// synopsys translate_off
	initial
 ...
 | man_add_sub_res_mag_dffe21_wo[22]), (man_res_not_zero_w2[19] | man_add_sub_res_mag_dffe21_wo[21]), (man_res_not_zero_w2[18] | man_add_sub_res_mag_dffe21_wo[20]), (man_res_not_zero_w2[17] | man_add_sub_res_mag_dffe21_wo[19]), (man_res_not_zero_w2[16] | man_add_sub_res_mag_dffe21_wo[18]), (man_res_not_zero_w2[15] | man_add_sub_res_mag_dffe21_wo[17]), (man_res_not_zero_w2[14] | man_add_sub_res_mag_dffe21_wo[16]), (man_res_not_zero_w2[13] | man_add_sub_res_mag_dffe21_wo[15]), (man_res_not_zero_w2[12] | man_add_sub_res_mag_dffe21_wo[14]), (man_res_not_zero_w2[11] | man_add_sub_res_mag_dffe21_wo[13]), (man_res_not_zero_w2[10] | man_add_sub_res_mag_dffe21_wo[12]), (man_res_not_zero_w2[9] | man_add_sub_res_mag_dffe21_wo[11]), (man_res_not_zero_w2[8] | man_add_sub_res_mag_dffe21_wo[10]), (man_res_not_zero_w2[7] | man_add_sub_res_mag_dffe21_wo[9]), (man_res_not_zero_w2[6] | man_add_sub_res_mag_dffe21_wo[8]), (man_res_not_zero_w2[5] | man_add_sub_res_mag_dffe21_wo[7]), (man_res_not_zero_w2[4] | man_add_sub_res_mag_dffe21_wo[6]), (man_res_not_zero_w2[3] | man_add_sub_res_mag_dffe21_wo[5]), (man_res_not_zero_w2[2] | man_add_sub_res_mag_dffe21_wo[4]), (man_res_not_zero_w2[1] | man_add_sub_res_mag_dffe21_wo[3]), (man_res_not_zero_w2[0] | man_add_sub_res_mag_dffe21_wo[2]), man_add_sub_res_mag_dffe21_wo[1]},
		...
		underflow_flag_w = ((((~ force_nan_w) & (~ force_infinity_w)) & (~ force_zero_w)) & denormal_res_dffe4_wo),
		zero = (~ zero_flag_n_dffe5_wo),
		zero_flag_n_dffe5_wi = zero_flag_n_w,
		zero_flag_n_dffe5_wo = zero_flag_n_dffe5,
		zero_flag_n_w = (~ (((~ force_nan_w) & (~ force_infinity_w)) & (force_zero_w | denormal_flag_w))),
...
endmodule //FP_ADDSUB_altfp_add_sub_85n
//VALID FILE
...
module FP_ADDSUB (
	...
	FP_ADDSUB_altfp_add_sub_85n	FP_ADDSUB_altfp_add_sub_85n_component (
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
				.add_sub (add_sub),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL FP_ADDSUB.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FP_ADDSUB.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FP_ADDSUB.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FP_ADDSUB_inst.v FALSE
