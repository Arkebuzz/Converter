...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" OPERATION="FLOAT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 clock dataa nan overflow result underflow
...
module  CONVERTFTD_altfp_convert_ffp
	( 
	clock,
	dataa,
	nan,
...
endmodule //CONVERTFTD_altfp_convert_ffp
//VALID FILE
...
module CONVERTFTD (
	...
	CONVERTFTD_altfp_convert_ffp	CONVERTFTD_altfp_convert_ffp_component (
				.clock (clock),
				.dataa (dataa),
				.overflow (sub_wire0),
				.underflow (sub_wire1),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVERTFTD.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVERTFTD.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVERTFTD.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVERTFTD_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVERTFTD_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVERTFTD.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CONVERTFTD.cmp FALSE TRUE
